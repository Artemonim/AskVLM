### Artemonim's Speech Kit — Автосубтитры: производственный пайплайн и интеграция с DaVinci Resolve
...
3) В Speech Kit создать `.srt` (и при желании предварительный «вжаренный» файл).
...
Примечание: мост/плагин Resolve возможен позже; быстрый путь сейчас — «audio‑only экспорт → SRT → импорт» либо watch‑folder режим в Speech Kit.
